...
export const SelectForm = ({ errors, getFieldProps, setFieldValue, touched, register }: SelectFormProps) => {
  ...
  useEffect(() => {
    if (register === "Registros de placas") {
      setFieldValue("filter", "-");
    }
  }, [register, fieldPropsFilter.value, fieldPropsActuatorFilter.value, setFieldValue]);
